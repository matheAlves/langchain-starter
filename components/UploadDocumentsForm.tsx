...
export function UploadDocumentsForm() {
  ...
  return (
    ...
    <textarea
      placeholder="Separe o texto em parágrafos para melhor ingestão e indexação dos dados."
      className="grow mr-8 p-4 rounded"
      value={document}
      onChange={(e) => setDocument(e.target.value)}
    ></textarea>
    <button type="submit" className="shrink-0 px-8 py-4  rounded w-28 bg-white hover:bg-blue-500 border-2 border-blue-500 text-blue-500 hover:text-white transition duration-500 ease-in-out">
