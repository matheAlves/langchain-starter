...
export function UploadDocumentsForm() {
  ...
  return (
    ...
    ></textarea>
    <button type="submit" className="shrink-0 px-8 py-4  rounded w-28 bg-black hover:bg-white border-2 border-white text-white hover:text-black transition duration-500 ease-in-out">
